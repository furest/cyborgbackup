...
class JobSerializer(DynamicFieldsSerializerMixin, BaseSerializer):
    ...
    class Meta:
        ...
        fields = ('*', 'launch_type', 'status', 'policy',
                  ...
                  'dependent_jobs', 'result_traceback', 'event_processing_finished', 'job_type', '+partitioning')
